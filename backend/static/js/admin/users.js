...
(() => {
  ...
  const listUrl = cfg.listUrl || "/api/v1/admin/users/coordinators";
  const createUrl = cfg.createUrl || "/api/v1/admin/users/coordinators";
  const updateBase = cfg.updateBase || "/api/v1/admin/users/coordinators/"; // + id
  const programsUrl = cfg.programsUrl || "/api/v1/programs";
