...
from utils.msgraph_mail import build_auth_url, process_auth_code, acquire_token_silent, clear_account_and_cache, read_account_info
...
def ms_callback():
    ...
    return redirect(url_for("admin_surveys_pages.admin_surveys"))
