...
from utils.admit_window import is_student_window_open, get_student_window, fmt_spanish
import os
...
def gate_student_period():
    ...
    if request.endpoint == "student_pages.student_close" and is_student_window_open():
        return redirect(url_for("student_pages.student_home"))
    if request.endpoint in ("student_pages.student_close", "student_pages.student_requests"):
        return
